...
@section('content')
<div class="page-title">إضافة منتج</div>
<div class="card">
    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid-2">
            ...
            <div class="input-grp">
                ...
                <input type="text" name="badge" placeholder="مثل: خصم 20%" value="{{ old('badge') }}">
            </div>
            <div class="input-grp">
        ...
        <div class="input-grp" style="margin-top:12px">
            ...
            <textarea name="features" rows="4" placeholder="بروتين عالي الجودة&#10;خالي من اللاكتوز&#10;نكهة الشوكولاتة">{{ old('features') }}</textarea>
        </div>
