...
@section('content')
<div class="page-title">إضافة مريض جديد</div>
<div class="card" style="max-width:500px">
    <form method="POST" action="{{ route('doctor.patients.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div style="margin-top:1rem;display:flex;gap:8px">
            ...
            <a href="{{ route('doctor.patients') }}" class="btn">إلغاء</a>
        </div>
    </form>
</div>
@endsection
