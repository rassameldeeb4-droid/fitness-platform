...
.product-img{height:120px;display:flex;align-items:center;justify-content:center;font-size:40px;position:relative;overflow:hidden}
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:10px">
    ...
    <div class="product-card">
        <div class="product-img" style="background:#E1F5EE">
            ...
            @if($p->image)
            <img src="{{ Storage::url($p->image) }}" alt="" style="width:100%;height:100%;object-fit:cover;position:absolute;top:0;left:0">
            @else
        ...
        <div class="product-body">
            ...
            <form method="POST" action="{{ route('cart.add') }}" style="width:100%">
                ...
                <button type="submit" class="btn btn-primary" style="width:100%;font-size:12px;padding:6px"><i class="ti ti-shopping-cart"></i> أضف للسلة</button>
            </form>
        </div>
    </div>
    @empty
