...
class WorkoutPlanController extends Controller
{
    public function create($memberId)
    {
        ...
        return view('trainer.workout-create', compact('member'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('trainer.workout.show', $plan->id)->with('success', 'تم إنشاء خطة التدريب');
    }

    public function show($id)
    {
        $plan = WorkoutPlan::with('member', 'days.exercises')->findOrFail($id);
        return view('trainer.workout-show', compact('plan'));
    }
}
