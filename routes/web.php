...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/exercises/{id}/delete-image', [AdminExerciseController::class, 'deleteImage'])->name('exercises.delete-image');
        Route::get('/exercises/{id}/delete-video', [AdminExerciseController::class, 'deleteVideo'])->name('exercises.delete-video');
